const api = 'https://api.open-meteo.com/v1/forecast?latitude=35.54414&longitude=139.76812&hourly=temperature_2m&daily=weather_code,temperature_2m_max,temperature_2m_min,precipitation_sum&timezone=Asia%2FTokyo';
...
function makePage(data) {
    ...
    setData('weathercode0', data.daily.weather_code[0]);
    setData('weathercode1', data.daily.weather_code[1]);
    setData('weathercode2', data.daily.weather_code[2]);
